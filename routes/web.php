...
Route::middleware(['auth', 'role:teacher'])->prefix('teacher')->name('teacher.')->group(function () {
    ...
    Route::get('/classes/sessions/{session}/attendance', [TeacherClassAttendanceController::class, 'show'])->name('classes.attendance.show');
    Route::post('/classes/sessions/{session}/attendance/{assignment}/mark', [TeacherClassAttendanceController::class, 'mark'])->name('classes.attendance.mark');
    ...
    Route::get('/plans/{plan}/sessions/{session}/attendance', [TeacherPlanAttendanceController::class, 'show'])->name('plans.sessions.attendance.show');
    Route::post('/plans/{plan}/sessions/{session}/attendance/{user}/mark', [TeacherPlanAttendanceController::class, 'mark'])->name('plans.sessions.attendance.mark');
