        ...
        <div class="mx-auto max-w-6xl space-y-6">
            <div class="flex flex-col gap-4 rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-500 dark:text-slate-400">Platform subscription invoices for the client account. This is separate from student or class payments inside the studio.</p>
                </div>
            ...
            <section class="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h2 class="text-xl font-black text-slate-950 dark:text-white">Invoice Records</h2>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Generated from platform subscription payment records.</p>
                    </div>
                    <div class="rounded-2xl bg-slate-100 px-4 py-2 text-sm font-black text-slate-700 dark:bg-gray-800 dark:text-gray-200">{{ $payments->count() }} records</div>
                </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-14 text-center">
                                        <p class="text-lg font-black text-slate-950 dark:text-white">No invoices yet</p>
                                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Invoices will appear here after platform subscription payments are recorded.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
