<x-customer-layout>
    <div class="space-y-6">
        ...
        @if (session('status') === 'profile-updated')
            <div class="rounded-3xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-bold text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-950/40 dark:text-emerald-200">
            ...
            <div class="space-y-6">
                ...
                <section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm font-semibold text-slate-500 dark:text-slate-400">Change the password used to access the client portal and assigned studio admin area.</p>
                    </div>
                    <div class="max-w-2xl">
            ...
            <aside class="space-y-6">
                ...
                <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    @if(auth()->user()->role === 'admin')
                        <div class="mt-5 rounded-3xl border border-red-100 bg-red-50 p-4 dark:border-red-900/50 dark:bg-red-950/30">
