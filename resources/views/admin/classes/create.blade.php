        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Create a class template and generate one or many sessions.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.classes.store') }}" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input name="class_name" required value="{{ old('class_name') }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input name="venue_name" value="{{ old('venue_name') }}"
                               class="mt-1 w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                               type="text" placeholder="e.g. Studio A, Main Hall" />
                    </div>
                </div>
                ...
                <div id="recurrencePanel" class="hidden rounded-2xl border border-gray-200 dark:border-gray-700 p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div id="customDaysWrap" class="hidden">
                            ...
                            <input name="custom_frequency" value="{{ old('custom_frequency') }}" min="1" max="365"
                                   class="mt-1 w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function syncRecurrence() {
                ...
                // when turning off, also hide custom days UI
