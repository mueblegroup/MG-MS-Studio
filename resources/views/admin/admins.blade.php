<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Manage administrators, permissions, and system access.
                </p>
            </div>
                        ...
                        @forelse($admins as $admin)
                            <tr id="row-{{ $admin->id }}"
                                ...
                                <td class="p-4 text-center align-middle">
                                    <input type="checkbox"
                                        value="{{ $admin->email }}"
                                        class="admin-checkbox rounded border-gray-300
                                ...
                                $firstLetter = strtolower(substr($admin->name, 0, 1));
                                ...
                                <!-- Phone -->
                                <td class="p-4">
                                    <a href="https://wa.me/{{ $admin->phone_number }}"
                                       target="_blank"
                                       class="flex items-center gap-2 text-sm
                                              text-gray-600 dark:text-gray-400
    ...
    <script>
        document.getElementById('send-mass-email').addEventListener('click', () => {
            const emails = [...document.querySelectorAll('.admin-checkbox:checked')]
                .map(cb => cb.value);
