<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Manage teachers, permissions, and system access.
                </p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse($teachers as $teacher)
                            <tr id="row-{{ $teacher->id }}"
                                ...
                                $firstLetter = strtolower(substr($teacher->name, 0, 1));
                                ...
                                <!-- Phone -->
                                <td class="p-4">
                                    <a href="https://wa.me/{{ $teacher->phone_number }}"
                                       target="_blank"
                                       class="flex items-center gap-2 text-sm
                                              text-gray-600 dark:text-gray-400
    ...
    <script>
        document.getElementById('send-mass-email').addEventListener('click', () => {
            const emails = [...document.querySelectorAll('.teacher-checkbox:checked')]
                .map(cb => cb.value);
