...
switch (Auth::user()->role) {
    ...
    case 'teacher':
        $sidebarLinks = [
            ...
            ['label' => 'My Classes', 'route' => 'teacher.classes', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
            ['label' => 'Student Progress', 'route' => 'teacher.progress', 'icon' => 'M12 6.253v13m0-13C10.832 5.433 9.062 5.567 5.23 7.318A7.25 7.25 0 0012 21.253a7.25 7.25 0 006.77-13.935C14.938 5.567 13.168 5.433 12 6.253z'],
        ];
        break;
    ...
    case 'student':
        $sidebarLinks = [
            ...
            ['label' => 'My Courses', 'route' => 'student.courses', 'icon' => 'M8 14v20M0 0v24'], // Example path
